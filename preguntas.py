...
def pregunta_10():
    ...
    """
    import pandas as pd
    tbl0 = pd.read_csv("https://raw.githubusercontent.com/ciencia-de-los-datos/programacion-usando-pandas-DiegoAlexUNALMED/main/tbl0.tsv", sep = "\t")
...
def pregunta_13():
    ...
    tbl02 = tbl02.groupby(by = '_c1').sum()['_c5b']
    return tbl02
